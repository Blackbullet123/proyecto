...
class Principal:
    def __init__(self):
        ...
        menu_archivo.add_command(label='Ayuda', command=abrir_pdf)
        ...
        def abrir():
            ...
            class Principal2:
                def __init__(self):
                    ...
                    insertar_vehiculos = CTkButton(button_frame,text="Insertar Vehiculos",command=insertar,corner_radius=15, 
                                           text_color="white",width=200,height=50,cursor='hand2',
                                           border_color="lightgreen",border_width=2,
                                        fg_color="#005954",hover_color="#5acf59", font=("Impact", 20),
                                        image=CTkImage(dark_image=added,light_image=added))
