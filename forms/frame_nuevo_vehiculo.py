...
class FrameNuevoVehiculo(CTkFrame):
    def __init__(self, parent, controlador):
        ...
        frame_entry = CTkFrame(frame_inferior, fg_color="transparent")
        frame_entry.pack(side="top",fill=X, pady=20)

        cod_marca = CTkLabel(frame_entry, text="Codigo", text_color="black", font=("Ubuntu", 14))
        cod_marca.grid(row=0,column=0, padx=10,pady=10, sticky="ew")
        codigo_marca = CTkEntry(frame_entry,fg_color="#c1e3f1",text_color="black", border_color="#002950")
        ...
        placa_label.grid(row=0,column=2, padx=10,pady=10)
        placa_entry = CTkEntry(frame_entry,fg_color="#c1e3f1",text_color="black", border_color="#002950")
        ...
        color_label.grid(row=0,column=4, padx=10,pady=10)
        color_entry = CTkEntry(frame_entry,fg_color="#c1e3f1",text_color="black", border_color="#002950")
        color_entry.grid(row=0,column=5, padx=10,pady=10)

        año_label = CTkLabel(frame_entry, text="Año", text_color="black", font=("Ubuntu", 14))
        año_label.grid(row=1,column=0, padx=10,pady=10)
        año_entry = CTkEntry(frame_entry,fg_color="#c1e3f1",text_color="black", border_color="#002950")
        año_entry.grid(row=1,column=1, padx=10,pady=10)

        marca_label = CTkLabel(frame_entry, text="Marca", text_color="black", font=("Ubuntu", 14))
        marca_label.grid(row=1,column=2, padx=10,pady=10)
        marca_entry = CTkEntry(frame_entry,fg_color="#c1e3f1",text_color="black", border_color="#002950")
        ...
        modelo_label.grid(row=1,column=4, padx=10,pady=10)
        modelo_entry = CTkEntry(frame_entry,fg_color="#c1e3f1",text_color="black", border_color="#002950")
